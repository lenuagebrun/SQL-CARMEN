...
-- SELECT name FROM country WHERE region LIKE 'Southern Europe' ORDER BY population LIMIT 1;
...
-- SELECT countrycode FROM countrylanguage WHERE language LIKE 'Italian' ORDER BY percentage;
...
-- SELECT capital FROM country WHERE code LIKE 'ARG';
